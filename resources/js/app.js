...
window.addEventListener("load", function () {
    // if (
    //     window.location.href.includes("employeeLogin.php") ||
    //     window.location.href.includes("adminLogin.php") ||
    //     window.location.href.includes("login.php")
    // ) {
    if (window.location.href.includes("http://127.0.0.1:8000/login")) {
        console.log("working");
        loginvalidations();
        hidepassword();
        keypress(0);
    ...
    //         "http://127.0.0.1:8000/adminui_inventory_list"
    //     )
    // ) {
    //     console.log("loaded");
    ...
    //     // click(1);
    //     // this.document
    //     //     .getElementById("modle")
    //     //     .addEventListener("click", function () {
    //     //         // let x = this.document.getElementById("modle").value;
...
function keypress(a) {
    ...
    let t = s.value;
    document
        .getElementsByClassName("posiitioninput")
